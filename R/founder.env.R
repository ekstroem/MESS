...
#' @rdname founder.shared
#' @export
founder.shared <- function (id, ...)
{
  UseMethod("founder.shared")
}


#' @rdname founder.shared
#' @export
founder.shared.pedigreeList <- function (id, ...)
{
...
#' @rdname founder.shared
#' @export
founder.shared.pedigree <- function (id, ...)
{
  n <- length(id$id)
