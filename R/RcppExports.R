...
#' @export
lmm_Maximize_cpp <- function(y, x, vc, maxiter = 25L, REML = TRUE, tolerance = 0.000001, reparam = FALSE, scale = TRUE, addresidual = TRUE) {
    .Call('MESS_lmm_Maximize_cpp', PACKAGE = 'MESS', y, x, vc, maxiter, REML, tolerance, reparam, scale, addresidual)
}
