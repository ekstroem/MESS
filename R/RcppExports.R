...
#' Fast column sum of matrix product
#'
#' @description Fast computation of colSum(x %*% M)
#' @param x A matrix with dimensions k*n.
#' @param M A matrix with dimenions n*m. 
#' @return A vector of length k giving the column sum of the matrix product
#' @author Claus Ekstrom <claus@@rprimer.dk>
#' @export
colSumProd <- function(x, M) {
    .Call('MESS_colSumProd', PACKAGE = 'MESS', x, M)
}
...
#' @export
fwrite <- function(df) {
    .Call('MESS_fwrite', PACKAGE = 'MESS', df)
}

#' @export
toCharMatrix <- function(df) {
    .Call('MESS_toCharMatrix', PACKAGE = 'MESS', df)
}
